const cache = 'memory-everyday-v54';
const files = ['/', '/index.html', '/styles.css?v=54', '/calendar-month.css?v=54', '/push-notifications.css?v=54', '/app.js?v=54', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
