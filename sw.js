const cache = 'memory-everyday-v61';
const files = ['/', '/index.html', '/styles.css?v=59', '/calendar-month.css?v=59', '/push-notifications.css?v=59', '/memo.css?v=2', '/app.js?v=61', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
