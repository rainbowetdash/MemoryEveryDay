const cache = 'memory-everyday-v59';
const files = ['/', '/index.html', '/styles.css?v=59', '/calendar-month.css?v=59', '/push-notifications.css?v=59', '/app.js?v=59', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
