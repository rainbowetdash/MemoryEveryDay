const cache = 'memory-everyday-v62';
const files = ['/', '/index.html', '/styles.css?v=59', '/calendar-month.css?v=59', '/push-notifications.css?v=59', '/memo.css?v=2', '/memo-editor.css?v=1', '/app.js?v=62', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
