const cache = 'memory-everyday-v66';
const files = ['/', '/index.html', '/styles.css?v=59', '/calendar-month.css?v=59', '/push-notifications.css?v=59', '/memo.css?v=2', '/memo-editor.css?v=4', '/app.js?v=64', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
