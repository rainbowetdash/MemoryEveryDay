const cache = "memory-everyday-v230";
const files = [
  "/todo-planning.js?v=3",
  "/todo-planning.css?v=6",
  ...
  "/event-colors.css?v=6",
  "/todos.css?v=2",
  "/voice-assistant.css?v=5",
  "/memo-time-suggestions.js?v=1",
  "/calendar-reschedule.js?v=2",
  "/calendar-dot-visibility.js?v=1",
  "/desktop-widget.html",
  "/memory-everyday-app-icon.png?v=1",
  "/desktop-widget.css?v=9",
  "/desktop-widget-model.js?v=6",
  "/desktop-widget.js?v=13",
  "/app.js?v=187",
  "/calendar-drag.js?v=2",
  "/settings.js?v=10",
  "/voice-assistant.js?v=8",
  "/release-info.json?v=56",
