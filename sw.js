const cache = 'memory-everyday-v70';
const files = ['/', '/index.html', '/styles.css?v=59', '/calendar-month.css?v=59', '/push-notifications.css?v=59', '/memo.css?v=2', '/memo-editor.css?v=4', '/memo-popover.css?v=1', '/memo-color-fix.css?v=1', '/memo-mobile-toolbar.css?v=1', '/app.js?v=66', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
