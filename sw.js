const cache = 'memory-everyday-v55';
const files = ['/', '/index.html', '/styles.css?v=55', '/calendar-month.css?v=55', '/push-notifications.css?v=55', '/app.js?v=55', '/manifest.webmanifest', '/icon.svg', '/wecom-daily-memo-icon.png'];
